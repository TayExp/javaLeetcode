...
public class SquaresOnCylinder3 {
	public int[][] result = new int[33][8];
	public int sum = -1;//sum+1
	...
	public int[][] solveNQueens(int len, int n) {
		...
		int[][] board = new int[len/n+1][n]; //存放index
	...
	public static void main(String[] args) {
		System.out.println(new SquaresOnCylinder3().solveNQueens(263,8));
	}
